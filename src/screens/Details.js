    ...
    <View style={styles.basicDetail}>
      ...
      {!openPhotoRoute ? (
        <View>
          ...
          <Text style={styles.text1}>A few more things</Text>
            ...
            <View style={styles.pickerDiv}>
              ...
              <Pressable onPress={onPress}>
                <View style={styles.dobPicker}>
                  ...
                  <Image
                    source={require('../../assets/dropdown-img.png')}
            ...
            <View style={styles.pickerDiv}>
              <DropDownPicker
                ...
                ArrowDownIconComponent={({style}) => (
                  <Image source={require('../../assets/dropdown-img.png')} />
                )}
                ArrowUpIconComponent={({style}) => (
                  <Image source={require('../../assets/dropdownUp-img.png')} />
                )}
              />
            </View>
          </View>
